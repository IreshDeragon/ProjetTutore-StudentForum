...
<body>
    ...
    <form method="post">
    	...
    	<input type="nom_representant" placeholder="Nom représentant" disabled="disabled" name="nom_representant" value="<?php echo $row_donne_representant['nom_representant'];?>" required><br><br>

    	Prénom du représentant<br>
    	<input type="prenom_representant" placeholder="Prénom représentant" disabled="disabled" name="prenom_representant" value="<?php echo $row_donne_representant['prenom_representant'];?>" required><br><br>
    	...
    	<input type="nbetudiantaccepte" placeholder="Nombre d'étudiant accepté" disabled="disabled" name="nbetudiantacceptee" value="<?php echo $row_donne_stage['nbetudiantaccepte'];?>" required><br><br>
